...
RunScheduling()
{
    ...
    local tasks := [
        ; Жаба, жабенок, арена
        {
            Text: ["жаба дня", "работа крупье", "откормить жабу", "завершить работу", "покормить жабу", "отправить жабенка в детский сад", "на арену", "отправить жабенка на махач", "покормить жабу", "забрать жабенка", "покормить жабу"],
            Date: "23.02.2026",  ; Общая дата начала для всех
            Time: ["00:01", "00:05", "01:00", "03:00", "07:30", "09:00", "09:23", "12:00", "14:00", "16:00", "20:30"],  ; Время для каждой подзадачи
            DailyRepeats: [1, 1, 1, 1, 1, 1, 14, 1, 1, 1, 1],  ; Количество повторений в день (общая сумма повторений: 24)
            IntervalHours: [24, 24, 24, 24, 24, 24, 1, 24, 24, 24, 24],  ; Интервал для каждой подзадачи
